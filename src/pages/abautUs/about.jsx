    ...
    <main className="main__about">
      ...
      <h3 className="info_1__bold main__title__mobile">Мы семейная пара - Лёха и Катя. </h3>
        ...
        <div className="info_1__container">
          ...
          <p className='text__info1'>Вместе уже почти 8 лет, и у нас есть своё общее любимое дело.</p>
          <h3 className="info_1__bold">
            Мы занимаемся изготовлением гримерных зеркал и столиков уже более
            5 лет
          </h3>
          <p>
